...
const steps = [
  ...
  },
  {
    ...
    description:
      "TPassist runs automated functional analysis, selects the most appropriate TP method, conducts benchmarking, and generates compliant documentation.",
...
const faqs = [
  ...
  {
    question: "How does TPassist generate documents?",
    answer:
      "TPassist uses AI to analyze the financial data, intercompany transactions, and entity profiles you provide. It automatically performs functional analysis (FAR analysis), selects the most appropriate TP method, conducts benchmarking using comparable company data, and generates documentation that complies with CBDT Rule 10DA/10DB formats.",
  },
  {
    question: "Is the documentation CBDT/OECD compliant?",
    answer:
      "Yes. All documentation generated by TPassist follows the formats prescribed under CBDT Rules 10DA (Local File) and 10DB (Master File), as well as OECD Transfer Pricing Guidelines Chapter V. Our templates are reviewed and updated regularly by practicing transfer pricing professionals.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "TPassist's Entity Monitoring feature tracks structural changes in real time. When a new entity is added, an existing entity is restructured, or intercompany transaction patterns change, the system alerts you and automatically updates the functional analysis and documentation drafts.",
  },
  {
    ...
    <nav className="fixed top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-foreground">TPassist</span>
        </a>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            className="mx-auto mt-4 max-w-2xl text-muted"
          >
            From functional analysis to document generation, TPassist covers the
    ...
    <section className="bg-surface-alt py-20 sm:py-28" id="faq">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Everything you need to know about TPassist and transfer pricing
            compliance in India.
          </motion.p>
        </motion.div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="relative mx-auto mt-4 max-w-xl text-base text-white/70">
            Join hundreds of Indian CA firms already using TPassist to deliver
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <p className="text-xs text-muted">
            &copy; {new Date().getFullYear()} TPassist. All rights reserved.
          </p>
